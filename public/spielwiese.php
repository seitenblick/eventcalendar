...
<div class="container-fluid">
    ...
    <div class="event-filters">
        ...
        <div class="mb-10">
            <div class="event-categories">
                <button class="category-reset" data-filter="">Alle</button>
    ...
    <div class="rruleset" data-slice-start="" data-slice-end="" data-mode="simpleTable" data-event-id="" data-series-id="" data-count="" data-url="<?php /* https://eventcalendar.ap.seitenblick.com/json/EventApiRules.php.json */ ?>"></div>
</div>
